      ...
      <div className="about__content">
        ...
        <p style={{ 
          ...
          padding: "0 60px"
                    ...
                    웰링턴에 세워진 우리 교회가 궁금하시다면 눈과 귀로 몸과 마음으로 느껴보시는 건 어떨까요? 하나님이 궁금하다면, 찬양에 감격하고 싶다면, 말씀으로 하나님의 음성을 듣고 싶다면, 기도로 길을 묻고 싶다면, 성도의 교제와 사랑을 원한다면, 상처와 아픔으로 신음하고 있다면, 웰링턴 한인교회(하남교회)로 오세요.</p><br />

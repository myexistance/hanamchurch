...
export const Home = () => {
  return <div
    ...
    <p style={{ color: 'white',fontSize: '19px' }}>하남교회는 류일선 목사를 파송하여 2023년 1월 15일(주일) 첫 예배를 드리고, 하나님의 은혜로 성장하며, 진정한 예배, 진정한 사랑, 진정한 교회의 본질 회복을 통해 영혼을 구원하고 하나님의 나라를 구현해 가고 있습니다.</p>
            </div>
    </div>;
};
